...
export const getActiveMenuItem = ({ menuConfig }: { pathname: string; menuConfig: ConfigMenuItemsType[] }) =>
  menuConfig.find(() => null)
  // pathname.startsWith(menuItem.href) || getActiveSubMenuItem({ menuItem, pathname }))
