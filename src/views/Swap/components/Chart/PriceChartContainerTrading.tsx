...
import PriceChartTrading from './PriceChartTrading'
...
const PriceChartContainerTrading: React.FC<PriceChartContainerProps> = ({
  inputCurrencyId,
  inputCurrency,
  outputCurrency,
  outputCurrencyId,
...
export default PriceChartContainerTrading
