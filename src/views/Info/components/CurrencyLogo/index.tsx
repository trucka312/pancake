...
export const CurrencyLogo: React.FC<{
  ...
  return <StyledLogo size={size} src={src} style={rest.style} alt="token logo" {...rest} />
}
...
export const DoubleCurrencyLogo: React.FC<DoubleCurrencyLogoProps> = ({ address0, address1, size = 16, style }) => {
  return (
    <DoubleCurrencyWrapper style={style}>
